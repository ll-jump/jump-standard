 ...
 * @date 2020/5/9 0009
 */
public class JToStringStyle implements Serializable {
    private static final long serialVersionUID = -4027846671407331144L;
    public static final ToStringStyle JSON_STYLE = new JToStringStyle.JsonToStringStyle();
    ...
    private static final class JsonToStringStyle extends ToStringStyle {
        ...
        private void appendValueAsString(StringBuffer buffer, String value) {
            if (!StringUtils.isBlank(value) && (!value.startsWith(this.getArrayStart()) || !value.endsWith(this.getArrayEnd())) && (!value.startsWith(this.getContentStart()) || !value.endsWith(this.getContentEnd()))) {
                buffer.append("\"" + value + "\"");
            } else {
                buffer.append(value);
            }
